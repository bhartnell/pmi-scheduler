...
</html>`}a.s(["exportToExcel",()=>c,"exportToPDF",()=>d,"printRoster",()=>e])},760078,a=>{"use strict";var b=a.i(326363),c=a.i(648181),d=a.i(288774),e=a.i(186835),f=a.i(220693),g=a.i(470292),h=a.i(916059),i=a.i(198905);function j({config:a,disabled:j=!1}){let[k,l]=(0,c.useState)(!1),[m,n]=(0,c.useState)(null),o=(0,c.useRef)(null);(0,c.useEffect)(()=>{function a(a){o.current&&!o.current.contains(a.target)&&l(!1)}return document.addEventListener("mousedown",a),()=>document.removeEventListener("mousedown",a)},[]);let p=async b=>{if(0===a.data.length)return void alert("No data to export");n(b);try{switch(b){case"print":(0,i.printRoster)(a);break;case"pdf":await (0,i.exportToPDF)(a);break;case"excel":(0,i.exportToExcel)(a)}}catch(a){console.error("Export error:",a),alert("Export failed. Please try again.")}n(null),l(!1)};return(0,b.jsxs)("div",{className:"relative",ref:o,children:[(0,b.jsxs)("button",{onClick:()=>l(!k),disabled:j||0===a.data.length,className:"flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed",children:[(0,b.jsx)(d.Download,{className:"w-4 h-4"}),(0,b.jsx)("span",{children:"Export"}),(0,b.jsx)(e.ChevronDown,{className:`w-4 h-4 transition-transform ${k?"rotate-180":""}`})]}),k&&(0,b.jsxs)("div",{className:"absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-50",children:[(0,b.jsxs)("button",{onClick:()=>p("print"),disabled:null!==m,className:"w-full flex items-center gap-3 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 disabled:opacity-50",children:[(0,b.jsx)(f.Printer,{className:"w-4 h-4"}),(0,b.jsx)("span",{children:"print"===m?"Preparing...":"Print"})]}),(0,b.jsxs)("button",{onClick:()=>p("pdf"),disabled:null!==m,className:"w-full flex items-center gap-3 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 disabled:opacity-50",children:[(0,b.jsx)(h.FileText,{className:"w-4 h-4"}),(0,b.jsx)("span",{children:"pdf"===m?"Generating...":"Download PDF"})]}),(0,b.jsxs)("button",{onClick:()=>p("excel"),disabled:null!==m,className:"w-full flex items-center gap-3 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 disabled:opacity-50",children:[(0,b.jsx)(g.FileSpreadsheet,{className:"w-4 h-4"}),(0,b.jsx)("span",{children:"excel"===m?"Generating...":"Download Excel"})]})]})]})}a.s(["default",()=>j])},14687,a=>{"use strict";var b=a.i(326363),c=a.i(751413),d=a.i(731590),e=a.i(648181),f=a.i(389305),g=a.i(326786),h=a.i(305942),i=a.i(237789),j=a.i(812239),k=a.i(682011),l=a.i(490661),m=a.i(884541),n=a.i(831394),o=a.i(701933),p=a.i(760078);let q=[{key:"mce_complete",label:"mCE",fullName:"mCE Modules"},{key:"vax_uploaded",label:"Vax",fullName:"Vaccinations"},{key:"ridealong_scanned",label:"Ride-Along",fullName:"Ride-Along Complete"},{key:"clinical_1_complete",label:"Clinical 1",fullName:"Clinical Rotation 1"},{key:"clinical_2_complete",label:"Clinical 2",fullName:"Clinical Rotation 2"},{key:"clinical_3_complete",label:"Clinical 3",fullName:"Clinical Rotation 3"},{key:"vitals_tracker_date",label:"Vitals",fullName:"Vitals Assessment",isDate:!0}];function r(){let{data:a,status:r}=(0,c.useSession)(),s=(0,d.useRouter)(),[t,u]=(0,e.useState)([]),[v,w]=(0,e.useState)([]),[x,y]=(0,e.useState)([]),[z,A]=(0,e.useState)(!0),[B,C]=(0,e.useState)(null),[D,E]=(0,e.useState)(null),[F,G]=(0,e.useState)(""),[H,I]=(0,e.useState)(""),[J,K]=(0,e.useState)(!1);(0,e.useEffect)(()=>{"unauthenticated"===r&&s.push("/auth/signin")},[r,s]),(0,e.useEffect)(()=>{a&&L()},[a]),(0,e.useEffect)(()=>{F&&M()},[F]);let L=async()=>{A(!0);try{let a=await fetch("/api/instructor/me"),b=await a.json();if(b.success&&b.user&&(E(b.user.role),!(0,o.canAccessClinical)(b.user.role)))return void s.push("/");let c=await fetch("/api/lab-management/cohorts?activeOnly=true"),d=await c.json();if(d.success){let a=(d.cohorts||[]).filter(a=>a.program?.abbreviation==="AEMT");u(a),a.length>0&&G(a[0].id)}}catch(a){console.error("Error fetching data:",a)}A(!1)},M=async()=>{try{let[a,b]=await Promise.all([fetch(`/api/lab-management/students?cohortId=${F}`),fetch(`/api/clinical/aemt-tracking?cohortId=${F}`)]),c=await a.json(),d=await b.json();c.success&&w(c.students||[]),d.success&&y(d.tracking||[])}catch(a){console.error("Error fetching cohort data:",a)}},N=(a,b)=>{let c=x.find(b=>b.student_id===a);if(!c)return!1;let d=c[b];return"boolean"==typeof d?d:!!("string"==typeof d&&d.trim())||!!d},O=async(a,b)=>{if(!D||!(0,o.canEditClinical)(D))return;C(`${a}-${b}`);let c=N(a,b),d=q.find(a=>a.key===b),e=d?.isDate?c?null:new Date().toISOString().split("T")[0]:!c;try{(await fetch("/api/clinical/aemt-tracking",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({student_id:a,field:b,value:e})})).ok&&await M()}catch(a){console.error("Error toggling field:",a)}C(null)},P=v.filter(a=>{if(H){let b=H.toLowerCase();if(!`${a.first_name} ${a.last_name}`.toLowerCase().includes(b))return!1}return(!J||q.filter(b=>N(a.id,b.key)).length!==q.length)&&!0}),Q=v.length*q.length,R=v.reduce((a,b)=>a+q.filter(a=>N(b.id,a.key)).length,0),S=Q>0?Math.round(R/Q*100):0;if("loading"===r||z)return(0,b.jsx)("div",{className:"min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 to-cyan-100 dark:from-gray-900 dark:to-gray-800",children:(0,b.jsx)("div",{className:"animate-spin rounded-full h-12 w-12 border-b-2 border-teal-600"})});if(!a)return null;let T=D&&(0,o.canEditClinical)(D),U=t.find(a=>a.id===F),V=U?`AEMT Group ${U.cohort_number}`:"AEMT",W={title:"AEMT Student Tracking Roster",subtitle:U?V:void 0,filename:`aemt-tracking-${V.replace(/\s+/g,"-").toLowerCase()}-${new Date().toISOString().split("T")[0]}`,columns:[{key:"name",label:"Student Name",getValue:a=>`${a.first_name} ${a.last_name}`},{key:"email",label:"Email",getValue:a=>a.email||""},...q.map(a=>({key:a.key,label:a.label,getValue:b=>N(b.id,a.key)})),{key:"progress",label:"Progress",getValue:a=>{let b=q.filter(b=>N(a.id,b.key)).length;return`${Math.round(b/q.length*100)}%`}}],data:P};return(0,b.jsxs)("div",{className:"min-h-screen bg-gradient-to-br from-teal-50 to-cyan-100 dark:from-gray-900 dark:to-gray-800",children:[(0,b.jsx)("div",{className:"bg-white dark:bg-gray-800 shadow-sm",children:(0,b.jsxs)("div",{className:"max-w-7xl mx-auto px-4 py-6",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-2",children:[(0,b.jsxs)(f.default,{href:"/",className:"hover:text-teal-600 dark:hover:text-teal-400 flex items-center gap-1",children:[(0,b.jsx)(h.Home,{className:"w-3 h-3"}),"Home"]}),(0,b.jsx)(g.ChevronRight,{className:"w-4 h-4"}),(0,b.jsx)(f.default,{href:"/clinical",className:"hover:text-teal-600 dark:hover:text-teal-400",children:"Clinical"}),(0,b.jsx)(g.ChevronRight,{className:"w-4 h-4"}),(0,b.jsx)("span",{children:"AEMT Tracking"})]}),(0,b.jsxs)("div",{className:"flex items-center justify-between",children:[(0,b.jsxs)("div",{className:"flex items-center gap-3",children:[(0,b.jsx)("div",{className:"p-2 bg-purple-100 dark:bg-purple-900/30 rounded-lg",children:(0,b.jsx)(i.ClipboardCheck,{className:"w-6 h-6 text-purple-600 dark:text-purple-400"})}),(0,b.jsxs)("div",{children:[(0,b.jsx)("h1",{className:"text-2xl font-bold text-gray-900 dark:text-white",children:"AEMT Student Tracking"}),(0,b.jsx)("p",{className:"text-gray-600 dark:text-gray-400",children:"Track mCE, vaccinations, ride-alongs, clinicals, and vitals"})]})]}),(0,b.jsxs)("div",{className:"flex items-center gap-4",children:[(0,b.jsxs)("div",{className:"text-right",children:[(0,b.jsxs)("div",{className:"text-2xl font-bold text-purple-600 dark:text-purple-400",children:[S,"%"]}),(0,b.jsx)("div",{className:"text-sm text-gray-500 dark:text-gray-400",children:"Complete"})]}),(0,b.jsx)(p.default,{config:W,disabled:!F||0===P.length})]})]})]})}),(0,b.jsxs)("main",{className:"max-w-7xl mx-auto px-4 py-6 space-y-4",children:[(0,b.jsx)("div",{className:"bg-white dark:bg-gray-800 rounded-lg shadow p-4",children:(0,b.jsxs)("div",{className:"flex flex-wrap gap-4 items-center",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2",children:[(0,b.jsx)(j.Users,{className:"w-5 h-5 text-gray-400"}),(0,b.jsxs)("select",{value:F,onChange:a=>G(a.target.value),className:"px-3 py-2 border rounded-lg text-gray-900 dark:text-white bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 min-w-[200px]",children:[(0,b.jsx)("option",{value:"",children:"Select AEMT Cohort"}),t.map(a=>(0,b.jsxs)("option",{value:a.id,children:["AEMT Group ",a.cohort_number]},a.id))]})]}),(0,b.jsxs)("div",{className:"flex-1 min-w-[200px] relative",children:[(0,b.jsx)(k.Search,{className:"absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400"}),(0,b.jsx)("input",{type:"text",value:H,onChange:a=>I(a.target.value),placeholder:"Search student...",className:"w-full pl-10 pr-4 py-2 border rounded-lg text-gray-900 dark:text-white bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600"})]}),(0,b.jsxs)("label",{className:"flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 cursor-pointer",children:[(0,b.jsx)("input",{type:"checkbox",checked:J,onChange:a=>K(a.target.checked),className:"w-4 h-4 text-purple-600 rounded"}),"Show incomplete only"]})]})}),0===t.length&&!z&&(0,b.jsxs)("div",{className:"bg-white dark:bg-gray-800 rounded-lg shadow p-8 text-center",children:[(0,b.jsx)(j.Users,{className:"w-12 h-12 text-gray-300 dark:text-gray-600 mx-auto mb-3"}),(0,b.jsx)("p",{className:"text-gray-500 dark:text-gray-400",children:"No AEMT cohorts found"})]}),F&&(0,b.jsx)("div",{className:"bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden",children:(0,b.jsx)("div",{className:"overflow-x-auto",children:(0,b.jsxs)("table",{className:"w-full",children:[(0,b.jsx)("thead",{className:"bg-gray-50 dark:bg-gray-700",children:(0,b.jsxs)("tr",{children:[(0,b.jsx)("th",{className:"px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider sticky left-0 bg-gray-50 dark:bg-gray-700 z-10",children:"Student"}),q.map(a=>(0,b.jsx)("th",{className:"px-3 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider whitespace-nowrap",title:a.fullName,children:a.label},a.key)),(0,b.jsx)("th",{className:"px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider",children:"Progress"})]})}),(0,b.jsx)("tbody",{className:"divide-y divide-gray-200 dark:divide-gray-700",children:0===P.length?(0,b.jsx)("tr",{children:(0,b.jsx)("td",{colSpan:q.length+2,className:"px-4 py-8 text-center text-gray-500 dark:text-gray-400",children:"No students found"})}):P.map(a=>{let c=Math.round(q.filter(b=>N(a.id,b.key)).length/q.length*100);return(0,b.jsxs)("tr",{className:"hover:bg-gray-50 dark:hover:bg-gray-700/50",children:[(0,b.jsx)("td",{className:"px-4 py-3 whitespace-nowrap sticky left-0 bg-white dark:bg-gray-800 z-10",children:(0,b.jsxs)("div",{className:"font-medium text-gray-900 dark:text-white",children:[a.first_name," ",a.last_name]})}),q.map(c=>{let d=N(a.id,c.key),e=B===`${a.id}-${c.key}`;return(0,b.jsx)("td",{className:"px-3 py-3 text-center",children:(0,b.jsx)("button",{onClick:()=>O(a.id,c.key),disabled:!T||e,className:`w-9 h-9 rounded-lg flex items-center justify-center transition-colors ${d?"bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 hover:bg-green-200 dark:hover:bg-green-900/50":"bg-gray-100 dark:bg-gray-700 text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600"} ${!T?"cursor-not-allowed":"cursor-pointer"}`,title:`${c.fullName}: ${d?"Complete":"Incomplete"}`,children:e?(0,b.jsx)(n.Loader2,{className:"w-4 h-4 animate-spin"}):d?(0,b.jsx)(l.Check,{className:"w-4 h-4"}):(0,b.jsx)(m.X,{className:"w-4 h-4"})})},c.key)}),(0,b.jsx)("td",{className:"px-4 py-3 text-center",children:(0,b.jsxs)("div",{className:"flex items-center gap-2",children:[(0,b.jsx)("div",{className:"flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden min-w-[60px]",children:(0,b.jsx)("div",{className:`h-full transition-all ${100===c?"bg-green-500":c>=75?"bg-yellow-500":"bg-red-500"}`,style:{width:`${c}%`}})}),(0,b.jsxs)("span",{className:"text-xs text-gray-500 dark:text-gray-400 w-10",children:[c,"%"]})]})})]},a.id)})})]})})}),!F&&t.length>0&&(0,b.jsxs)("div",{className:"bg-white dark:bg-gray-800 rounded-lg shadow p-8 text-center",children:[(0,b.jsx)(j.Users,{className:"w-12 h-12 text-gray-300 dark:text-gray-600 mx-auto mb-3"}),(0,b.jsx)("p",{className:"text-gray-500 dark:text-gray-400",children:"Select a cohort to view tracking data"})]})]})]})}a.s(["default",()=>r])},658627,a=>{a.v(b=>Promise.all(["server/chunks/ssr/e71d5_404b7277._.js"].map(b=>a.l(b))).then(()=>b(281420)))}];

//# sourceMappingURL=_claude_worktrees_focused-goodall_c94b6806._.js.map