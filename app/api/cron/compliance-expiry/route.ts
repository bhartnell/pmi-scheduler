...
export async function GET(request: NextRequest) {
  ...
  // ---------------------------------------------------------------------------
  // Check student_compliance_docs (wide-table schema).
  //
  // Removed 2026-07-01: the "normalized schema" check against
  // student_compliance_records + compliance_document_types was retired along
  // with the expiry-tracking Compliance Tracker — Ben doesn't track document
  // expirations, and those tables were dropped (migration
  // 20260701_remove_expiry_compliance_tracker.sql). This wide-table check
  // against student_compliance_docs (the Clinical Tracker's backing table)
  // is unaffected and remains the sole source here.
  // ---------------------------------------------------------------------------
