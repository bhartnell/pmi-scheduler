                    ...
                    <tbody className="divide-y dark:divide-gray-700">
                      {stats
                        ...
                        .map(student => {
                          ...
                          return (
                            <tr key={student.id} className={belowAvg ? 'bg-orange-50 dark:bg-orange-900/20' : ''}>
                              ...
                              <td className="px-4 py-3 text-center">
                                <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-sm font-medium ${
                                  belowAvg ? 'bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300' : 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300'
                                }`}>
