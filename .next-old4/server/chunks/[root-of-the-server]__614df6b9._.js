...
`}e.s(["EMAIL_COLORS",0,r,"emailButton",()=>a,"emailContentBox",()=>n,"emailHeading",()=>o,"emailParagraph",()=>i,"wrapInEmailTemplate",()=>s])},94080,e=>{"use strict";var t=e.i(876908),r=e.i(859727),a=e.i(604868);let n=process.env.NEXTAUTH_URL||"https://pmiparamedic.tools",o={labs:{label:"Lab Assignments",icon:"&#129514;",color:a.EMAIL_COLORS.warning,bgColor:"#fef3c7",borderColor:a.EMAIL_COLORS.warning,description:"New assignments and upcoming labs"},tasks:{label:"Tasks",icon:"&#128203;",color:a.EMAIL_COLORS.accent,bgColor:"#eff6ff",borderColor:a.EMAIL_COLORS.accent,description:"New tasks assigned and tasks due soon"},scheduling:{label:"Scheduling",icon:"&#128197;",color:a.EMAIL_COLORS.success,bgColor:"#ecfdf5",borderColor:a.EMAIL_COLORS.success,description:"New shifts available and signup confirmations"},feedback:{label:"Feedback",icon:"&#128172;",color:"#8b5cf6",bgColor:"#f5f3ff",borderColor:"#8b5cf6",description:"New reports and status changes"},clinical:{label:"Clinical",icon:"&#9877;&#65039;",color:a.EMAIL_COLORS.error,bgColor:"#fef2f2",borderColor:a.EMAIL_COLORS.error,description:"Hours updates, compliance due dates, and site visit reminders"},system:{label:"System",icon:"&#9881;&#65039;",color:a.EMAIL_COLORS.gray[500],bgColor:a.EMAIL_COLORS.gray[50],borderColor:a.EMAIL_COLORS.gray[200],description:"Account and system updates"}},i=["labs","tasks","scheduling","feedback","clinical","system"];function s(e,t){let r=o[e],i=t.length,s=t.map(e=>{let t=e.link_url?`<a href="${n}${e.link_url}" style="color: ${r.color}; text-decoration: none; font-weight: 600;">${d(e.title)}</a>`:`<strong style="color: ${a.EMAIL_COLORS.gray[900]};">${d(e.title)}</strong>`;return`
  ...
  `}function d(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}async function c(t,r,o){let{user_email:i,email_preferences:s}=r,d=Object.keys(s.categories).filter(e=>!0===s.categories[e]);if(0===d.length)return"skipped";let c="weekly"===o?168:24,p=new Date(Date.now()-60*c*6e4).toISOString(),{data:u,error:g}=await t.from("user_notifications").select("id, title, message, link_url, category, created_at").eq("user_email",i).eq("is_read",!1).is("digest_sent_at",null).gte("created_at",p).order("created_at",{ascending:!1});if(g)throw Error(`DB query failed for ${i}: ${g.message}`);if(!u||0===u.length)return"skipped";let m=l(u,d,o);if(!m)return"skipped";let f=`${n}/settings?tab=notifications`,x=(0,a.wrapInEmailTemplate)(m,f),{Resend:h}=await e.A(272920),y=process.env.RESEND_API_KEY?new h(process.env.RESEND_API_KEY):null,b=process.env.EMAIL_FROM||"PMI Paramedic Tools <notifications@pmiparamedic.tools>",w=new Date().toLocaleDateString("en-US",{month:"short",day:"numeric"}),R="weekly"===o?`[PMI] Weekly Summary - ${w}`:`[PMI] Daily Digest - ${w}`;if(y){let{error:e}=await y.emails.send({from:b,to:i,subject:R,html:x});if(e)throw Error(`Resend error for ${i}: ${e.message}`)}let E=u.map(e=>e.id),$=new Date().toISOString(),{error:_}=await t.from("user_notifications").update({digest_sent_at:$}).in("id",E);_&&console.error(`[DIGEST] Failed to mark notifications as digest_sent for ${i}:`,_.message);let O="weekly"===o?"weekly_digest":"daily_digest";return await t.from("email_log").insert({to_email:i,subject:R,template:O,status:"sent",sent_at:$}),"sent"}async function p(e,a){let n=e.headers.get("authorization"),o=process.env.CRON_SECRET;if(o&&n!==`Bearer ${o}`)return console.warn(`[DIGEST] Unauthorized ${a} cron request`),t.NextResponse.json({error:"Unauthorized"},{status:401});let i=Date.now(),s=(0,r.getSupabaseAdmin)(),l="weekly"===a?"weekly_digest":"daily_digest",{data:d,error:p}=await s.from("user_preferences").select("user_email, email_preferences").eq("email_preferences->>mode",l).eq("email_preferences->>enabled","true");if(p)return console.error(`[DIGEST] Failed to query ${a} digest users:`,p.message),t.NextResponse.json({error:`Failed to query ${a} digest users`,detail:p.message},{status:500});if(!d||0===d.length)return t.NextResponse.json({success:!0,mode:a,processed:0,sent:0,skipped:0,errors:[],duration_ms:Date.now()-i});let u=await Promise.allSettled(d.map(e=>c(s,e,a))),g=0,m=0,f=[];u.forEach((e,t)=>{let r=d[t]?.user_email??`user[${t}]`;if("fulfilled"===e.status)"sent"===e.value?g++:m++;else{let t=e.reason instanceof Error?e.reason.message:String(e.reason);console.error(`[DIGEST] Error processing ${r}:`,t),f.push(`${r}: ${t}`)}});let x={success:!0,mode:a,processed:d.length,sent:g,skipped:m,errors:f,duration_ms:Date.now()-i};return t.NextResponse.json(x)}async function u(e){return p(e,"daily")}e.s(["CATEGORY_META",()=>o,"CATEGORY_ORDER",()=>i,"GET",()=>u,"buildCategorySection",()=>s,"escapeHtml",()=>d,"generateDigestHtml",()=>l,"processDigest",()=>p])},581314,e=>{"use strict";var t=e.i(356292),r=e.i(511587),a=e.i(658158),n=e.i(385772),o=e.i(755949),i=e.i(68611),s=e.i(722194),l=e.i(570712),d=e.i(268070),c=e.i(375339),p=e.i(663426),u=e.i(962412),g=e.i(413713),m=e.i(569873),f=e.i(413654),x=e.i(193695);e.i(689710);var h=e.i(770056),y=e.i(94080);let b=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/cron/daily-digest/route",pathname:"/api/cron/daily-digest",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/.claude/worktrees/focused-goodall/app/api/cron/daily-digest/route.ts",nextConfigOutput:"standalone",userland:y}),{workAsyncStorage:w,workUnitAsyncStorage:R,serverHooks:E}=b;function $(){return(0,a.patchFetch)({workAsyncStorage:w,workUnitAsyncStorage:R})}async function _(e,t,a){b.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let y="/api/cron/daily-digest/route";y=y.replace(/\/index$/,"")||"/";let w=await b.prepare(e,t,{srcPage:y,multiZoneDraftMode:!1});if(!w)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:R,params:E,nextConfig:$,parsedUrl:_,isDraftMode:O,prerenderManifest:C,routerServerContext:v,isOnDemandRevalidate:S,revalidateOnlyGenerated:A,resolvedPathname:I,clientReferenceManifest:k,serverActionsManifest:L}=w,M=(0,s.normalizeAppPath)(y),P=!!(C.dynamicRoutes[M]||C.routes[I]),T=async()=>((null==v?void 0:v.render404)?await v.render404(e,t,_,!1):t.end("This page could not be found"),null);if(P&&!O){let e=!!C.routes[I],t=C.dynamicRoutes[M];if(t&&!1===t.fallback&&!e){if($.experimental.adapterPath)return await T();throw new x.NoFallbackError}}let D=null;!P||b.isDev||O||(D="/index"===(D=I)?"/":D);let N=!0===b.isDev||!P,q=P&&!N;L&&k&&(0,i.setManifestsSingleton)({page:y,clientReferenceManifest:k,serverActionsManifest:L});let j=e.method||"GET",H=(0,o.getTracer)(),U=H.getActiveScopeSpan(),z={params:E,prerenderManifest:C,renderOpts:{experimental:{authInterrupts:!!$.experimental.authInterrupts},cacheComponents:!!$.cacheComponents,supportsDynamicResponse:N,incrementalCache:(0,n.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:$.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,n)=>b.onRequestError(e,t,a,n,v)},sharedContext:{buildId:R}},F=new l.NodeNextRequest(e),B=new l.NodeNextResponse(t),G=d.NextRequestAdapter.fromNodeNextRequest(F,(0,d.signalFromNodeResponse)(t));try{let i=async e=>b.handle(G,z).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=H.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${j} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t)}else e.updateName(`${j} ${y}`)}),s=!!(0,n.getRequestMeta)(e,"minimalMode"),l=async n=>{var o,l;let d=async({previousCacheEntry:r})=>{try{if(!s&&S&&A&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let o=await i(n);e.fetchMetrics=z.renderOpts.fetchMetrics;let l=z.renderOpts.pendingWaitUntil;l&&a.waitUntil&&(a.waitUntil(l),l=void 0);let d=z.renderOpts.collectedTags;if(!P)return await (0,u.sendResponse)(F,B,o,z.renderOpts.pendingWaitUntil),null;{let e=await o.blob(),t=(0,g.toNodeOutgoingHttpHeaders)(o.headers);d&&(t[f.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==z.renderOpts.collectedRevalidate&&!(z.renderOpts.collectedRevalidate>=f.INFINITE_CACHE)&&z.renderOpts.collectedRevalidate,a=void 0===z.renderOpts.collectedExpire||z.renderOpts.collectedExpire>=f.INFINITE_CACHE?void 0:z.renderOpts.collectedExpire;return{value:{kind:h.CachedRouteKind.APP_ROUTE,status:o.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==r?void 0:r.isStale)&&await b.onRequestError(e,t,{routerKind:"App Router",routePath:y,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:S})},!1,v),t}},c=await b.handleResponse({req:e,nextConfig:$,cacheKey:D,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:C,isRoutePPREnabled:!1,isOnDemandRevalidate:S,revalidateOnlyGenerated:A,responseGenerator:d,waitUntil:a.waitUntil,isMinimalMode:s});if(!P)return null;if((null==c||null==(o=c.value)?void 0:o.kind)!==h.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(l=c.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||t.setHeader("x-nextjs-cache",S?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),O&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let x=(0,g.fromNodeOutgoingHttpHeaders)(c.value.headers);return s&&P||x.delete(f.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||x.get("Cache-Control")||x.set("Cache-Control",(0,m.getCacheControlHeader)(c.cacheControl)),await (0,u.sendResponse)(F,B,new Response(c.value.body,{headers:x,status:c.value.status||200})),null};U?await l(U):await H.withPropagatedContext(e.headers,()=>H.trace(c.BaseServerSpan.handleRequest,{spanName:`${j} ${y}`,kind:o.SpanKind.SERVER,attributes:{"http.method":j,"http.target":e.url}},l))}catch(t){if(t instanceof x.NoFallbackError||await b.onRequestError(e,t,{routerKind:"App Router",routePath:M,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:S})},!1,v),P)throw t;return await (0,u.sendResponse)(F,B,new Response(null,{status:500})),null}}e.s(["handler",()=>_,"patchFetch",()=>$,"routeModule",()=>b,"serverHooks",()=>E,"workAsyncStorage",()=>w,"workUnitAsyncStorage",()=>R])},272920,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__a801940c._.js"].map(t=>e.l(t))).then(()=>t(855644)))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__614df6b9._.js.map