...
> Snapshot 2026-05-23. Supersedes PMI-MASTER-REFERENCE-2026-03-08.
...
## Active Cohorts & Key IDs

| Cohort | UUID | Status |
|--------|------|--------|
| **PM G14** (Paramedic, S2) | `8577fdc3-eff6-4000-9302-1ee6e3043eeb` | Active; Wk 2+ as of late May |
| **PM G15** (Paramedic, S1) | `856bcf1d-2e85-48b5-92a3-aba941103109` | Active; ⚠ 0/20 students have email on file |
| **EMT G5** (EMT, S1) | `67080313-0c52-411b-8e88-2ae6e99eb6c6` | Active; templates fixed 2026-05-20 |

PM G14 has 23/23 students with email; PM G15 currently has 0/20 — surfaced as
an inline warning on the grading page (commit `fa8143b2`).
