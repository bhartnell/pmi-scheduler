...
> Refreshed 2026-07-15 (PALS Hub Build Plan Phases 5-6: AHA 2025 reference agenda display + Section A/B/C/D/E certification template seed + skills/attestation station styling on `/labs/pals-hub`).
