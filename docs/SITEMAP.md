...
> Refreshed 2026-07-14 (PALS Hub Build Plan: corrected practice TL threshold to ≥2 + oversized-group warning, station direct-links on both AHA hubs, calendar "Open Hub" deep-link with `?date=`).
