...
**Check Constraints:**
- `lvfr_schedule_items_item_type_check`: `(((item_type IS NULL) OR (item_type = ANY (ARRAY['chapter'::text, 'quiz'::text, 'skills'::text, 'break'::text, 'lab'::text, 'exam'::text, 'other'::text, 'activity'::text]))))`
