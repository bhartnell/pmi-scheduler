    ...
    return (
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-6 md:mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-2 md:mb-3">Select Poll Type</h1>
          <p className="text-gray-700 dark:text-gray-300 text-sm md:text-base">Choose the type of scheduling poll to create</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          ...
          >
            <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
              <div className="p-2 md:p-3 bg-blue-100 dark:bg-blue-900/30 rounded-lg"><UserCheck className="w-6 h-6 md:w-8 md:h-8 text-blue-600 dark:text-blue-400" /></div>
              <h2 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Individual Meeting</h2>
            </div>
            <p className="text-gray-700 dark:text-gray-300 mb-3 md:mb-4 text-sm md:text-base">One-on-one internship check-ins with student, FTO, and instructor.</p>
          ...
          >
            <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
              <div className="p-2 md:p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg"><UsersRound className="w-6 h-6 md:w-8 md:h-8 text-purple-600 dark:text-purple-400" /></div>
              <h2 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Group Session</h2>
            </div>
            <p className="text-gray-700 dark:text-gray-300 mb-3 md:mb-4 text-sm md:text-base">Testing days, competencies, or orientation with multiple students.</p>
            <ul className="space-y-1 md:space-y-2 text-xs md:text-sm text-gray-600 dark:text-gray-400">
    ...
    <div className="max-w-7xl mx-auto px-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 md:p-6 mb-4 md:mb-6">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Number of Weeks</label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Days to Include</label>
              <select
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-3 md:p-4 rounded-lg mb-4">
          <h3 className="font-semibold text-blue-900 dark:text-blue-200 mb-2 text-sm md:text-base">Poll Settings Summary:</h3>
          <ul className="space-y-1 text-xs md:text-sm text-blue-800 dark:text-blue-300">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            ...
            className="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:cursor-not-allowed text-sm md:text-base"
          >
            {loading ? 'Creating...' : `✓ Create Poll (${creatorSelectedSlots.length} slots)`}
          </button>
        </div>
        {!creatorSelectedSlots.length && pollConfig.startDate && (
          <p className="text-sm text-red-600 dark:text-red-400 mt-2">Please select at least one time slot below for participants to choose from.</p>
        )}
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 md:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
          <div>
            <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white">Select Available Time Slots *</h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">Click on cells to select which times participants can choose from.</p>
          </div>
          {pollConfig.startDate && (
            <div className="flex gap-2">
              <button
                onClick={selectAllSlots}
                className="px-3 py-1.5 text-sm bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/60"
              >
                Select All
              </button>
              <button
        ...
        {!pollConfig.startDate && (
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-3 mb-4">
            <p className="text-sm text-yellow-800 dark:text-yellow-300">Select a start date above to see the calendar.</p>
          </div>
        )}
        {pollConfig.startDate && (
          <SchedulerCalendar
            ...
            renderDesktopCell={(di, ti, slotKey) => {
              ...
              return (
                <div
                  ...
                  className={`p-2 md:p-3 border-r border-b border-gray-200 dark:border-gray-700 transition-colors cursor-pointer ${
                    isSelected
                ...
                <button
                  ...
                  className={`w-full p-4 rounded-lg border-2 text-left transition-all ${
                    isSelected
                      ...
                      : 'border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:border-blue-300 dark:hover:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-900/30'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <span className="font-medium">{timeSlots[ti]}</span>
                    {isSelected && (
                      <svg className="w-5 h-5 text-green-600 dark:text-green-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              <div className="flex items-center gap-1">
                <div className="w-5 h-5 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded"></div>
                <span className="text-xs text-gray-600 dark:text-gray-400">Not available</span>
              </div>
              <div className="flex items-center gap-1">
                <div className="w-5 h-5 bg-green-400 dark:bg-green-600 border-2 border-green-500 rounded"></div>
                <span className="text-xs text-gray-600 dark:text-gray-400">Available for selection</span>
              </div>
            </div>
