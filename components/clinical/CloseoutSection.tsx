  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow overflow-hidden">
      ...
      <div className="p-4 space-y-5">
        ...
        {/* 2026-04-24 redesign: removed five UI blocks per spec —
            Employment Verification, Preceptor Evaluation Request,
            Downloadable Paper Forms, Upload Documents drag-and-drop,
            and the Uploaded Documents list. The corresponding modals
            (EmploymentVerificationModal, PreceptorEvalModal) and
            their state hooks (showEmploymentModal,
            showPreceptorEvalModal, employmentVerification, documents,
            DOC_TYPE_*, file upload handlers, etc.) stay in place
            so the underlying API routes remain queryable for
            historical records. Only the rendered surface is gone. */}
