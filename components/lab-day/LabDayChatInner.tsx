...
// Renamed from LabDayChat → LabDayChatInner 2026-05-26 so it can be
// gated behind a feature flag by the LabDayChat wrapper in
// components/lab-day/LabDayChat.tsx. Behavior is unchanged.
export default function LabDayChatInner({
  labDayId,
  senderName,
  senderEmail,
  senderRole,
