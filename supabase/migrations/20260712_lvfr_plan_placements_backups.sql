...
--
-- Additive + idempotent. Already applied to production directly via the
-- Supabase MCP apply_migration tool on 2026-07-12 (draft PR #30); this
-- file re-applies the same repo-tracked migration so `main` and
-- production schema history stay in sync.
